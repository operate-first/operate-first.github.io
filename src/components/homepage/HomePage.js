  ...
  return (
    <div className={classes.hero}>
      ...
      <Container className={classes.container}>
        ...
        <Title className={classes.title}>Building an all-Open Source community cloud to learn and make <Link to="/purpose" className={classes.linkedText}>things*</Link> better</Title>
        <Group>
